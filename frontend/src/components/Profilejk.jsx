          ...
          <div>
            ...
            >
              ...
              <h6 style={{ fontWeight: 500 }}>
                {currentUser && currentUser.followers.length} Followers
              </h6>
              &nbsp;&nbsp;
              <h6 style={{ fontWeight: 500 }}>
                {currentUser && currentUser.following.length} Following
              </h6>
            </div>
            <button
